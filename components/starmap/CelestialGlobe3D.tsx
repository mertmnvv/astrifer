...
export function CelestialGlobe3D({ sky, palette, className = "" }: CelestialGlobe3DProps) {
  ...
  return (
    <div className={`relative w-full ${className}`}>
      ...
      <div className="absolute bottom-4 right-4 bg-void/50 border border-text/10 rounded-full px-3 py-1 font-mono text-[8.5px] uppercase tracking-widest text-dim select-none pointer-events-none">
